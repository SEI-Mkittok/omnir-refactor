...
export function getBreadcrumb(pathname: string): string {
  const map: Record<string, string> = {
    ...
    '/settings/picklists': 'Picklists',
    '/settings/picklist-dependencies': 'Picklist Dependencies',
    '/settings/lead-conversion-mapping': 'Lead Conversion Mapping',
    '/settings/roles': 'Roles',
    '/settings/profiles': 'Profiles',
    '/settings/sharing-rules': 'Sharing Rules',
    '/settings/groups': 'Groups',
    '/settings/sla':       'SLA Policies',
    '/settings/webhooks':  'Webhooks',
    '/settings/scheduler': 'Scheduler',
    '/settings/webforms':  'Webforms',
    '/settings/mail-converter': 'Mail Converter',
    '/settings/billing':       'Billing',
    '/settings/billing/plans': 'Billing — Plans',
    '/settings/integrations': 'Integrations',
    '/settings/product-help': 'Product Help',
