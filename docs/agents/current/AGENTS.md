...
1. Read `docs/agents/current/SOUL.md` — this is who you are
2. Read `docs/agents/current/USER.md` — this is who you're helping
3. Read `docs/memory/YYYY-MM-DD.md` (today + yesterday) for recent context
4. **If in MAIN SESSION** (direct chat with your human): Also read `docs/agents/current/MEMORY.md`
...
- **Daily notes:** `docs/memory/YYYY-MM-DD.md` (create `docs/memory/` if needed) — raw logs of what happened
- **Long-term:** `docs/agents/current/MEMORY.md` — your curated memories, like a human's long-term memory
...
- You can **read, edit, and update** `docs/agents/current/MEMORY.md` freely in main sessions
...
- When someone says "remember this" → update `docs/memory/YYYY-MM-DD.md` or relevant file
- When you learn a lesson → update `docs/agents/current/AGENTS.md`, `docs/agents/current/TOOLS.md`, or the relevant skill
...
Skills provide your tools. When you need one, check its `SKILL.md`. Keep local notes (camera names, SSH details, voice preferences) in `docs/agents/current/TOOLS.md`.
...
You are free to edit `docs/agents/current/HEARTBEAT.md` with a short checklist or reminders. Keep it small to limit token burn.
...
**Tip:** Batch similar periodic checks into `docs/agents/current/HEARTBEAT.md` instead of creating multiple cron jobs. Use cron for precise schedules and standalone tasks.
...
**Track your checks** in `docs/memory/heartbeat-state.json`:
...
1. Read through recent `docs/memory/YYYY-MM-DD.md` files
2. Identify significant events, lessons, or insights worth keeping long-term
3. Update `docs/agents/current/MEMORY.md` with distilled learnings
4. Remove outdated info from `docs/agents/current/MEMORY.md` that's no longer relevant
